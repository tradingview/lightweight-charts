...
The tutorial will assume that you've already read the [Getting Started](https://tradingview.github.io/lightweight-charts/docs.md) section even though we may repeat a few aspects from that guide.
