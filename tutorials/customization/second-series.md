...
In this section, we will be adding an [area series](https://tradingview.github.io/lightweight-charts/docs/series-types.md#area) to the chart with a subtle vertical gradient. It's purpose is solely for aesthetic reasons (only to make the chart more visually appealing). However, it will teach us a few key points about the differences between different series types and the visual stacking order.
...
[Interactive example](https://tradingview.github.io/lightweight-charts/284024c6e6f4b0f4427af4f26844eba5.html)
