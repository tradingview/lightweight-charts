...
We can adjust the chart's background color and text color by specifying our desired colors within the options for [IChartApi](https://tradingview.github.io/lightweight-charts/docs/api/interfaces/IChartApi). A full list of the available options for the chart instance can be viewed here: [ChartOptionsBase](https://tradingview.github.io/lightweight-charts/docs/api/interfaces/ChartOptionsBase).
...
We can set the border colors for the price and time scales by using the `applyOptions` method on the [IPriceScale](https://tradingview.github.io/lightweight-charts/docs/api/interfaces/IPriceScaleApi) and [ITimeScale](https://tradingview.github.io/lightweight-charts/docs/api/interfaces/ITimeScaleApi) instances. We can get references to these instances by using the `priceScale()` and `timeScale()` methods on a chart instance.
...
[Interactive example](https://tradingview.github.io/lightweight-charts/0a4c0fe0de7fc40be06eb3ccd55c3dc9.html)
