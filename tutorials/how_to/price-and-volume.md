...
[`priceScaleId`](https://tradingview.github.io/lightweight-charts/docs/api/interfaces/SeriesOptionsCommon#pricescaleid) to `''`.
An overlay doesn't make use of either the left or right price scale, and it's positioning
is controlled by setting the [`scaleMargins`](https://tradingview.github.io/lightweight-charts/docs/api/interfaces/PriceScaleOptions#scalemargins)
...
We are using the [Histogram](https://tradingview.github.io/lightweight-charts/docs/series-types.md#histogram) series type to draw the volume bars.
...
setting the [`scaleMargins`](https://tradingview.github.io/lightweight-charts/docs/api/interfaces/PriceScaleOptions#scalemargins) properties as follows:
...
- [OverlayPriceScale Options](https://tradingview.github.io/lightweight-charts/docs/api/type-aliases/OverlayPriceScaleOptions)
- [Histogram Series Type](https://tradingview.github.io/lightweight-charts/docs/series-types.md#histogram)
- [PriceFormat Types](https://tradingview.github.io/lightweight-charts/docs/api/interfaces/PriceFormatBuiltIn#type)
- [Scale Margins](https://tradingview.github.io/lightweight-charts/docs/api/interfaces/PriceScaleOptions#scalemargins)
