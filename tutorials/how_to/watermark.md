...
A simple text watermark can be configured and added by using the [`createTextWatermark`](https://tradingview.github.io/lightweight-charts/docs/next/api/functions/createTextWatermark) function exported
...
The options available for the watermark are: [TextWatermark Options](https://tradingview.github.io/lightweight-charts/docs/next/api/interfaces/TextWatermarkOptions).

You can see full [working examples](#examples) below.

## Resources

- [`createTextWatermark` function](https://tradingview.github.io/lightweight-charts/docs/next/api/functions/createTextWatermark).
- [TextWatermark Options](https://tradingview.github.io/lightweight-charts/docs/next/api/interfaces/TextWatermarkOptions)
...
If a simple text watermark doesn't meet your requirements then you can use the Image watermark via [`createImageWatermark`](https://tradingview.github.io/lightweight-charts/docs/next/api/functions/createImageWatermark) function exported
from the library as follows:
...
The options available for the watermark are: [ImageWatermark Options](https://tradingview.github.io/lightweight-charts/docs/next/api/interfaces/ImageWatermarkOptions).

You can see full [working examples](#examples) below.

## Resources

- [`createImageWatermark` pane primitive](https://tradingview.github.io/lightweight-charts/docs/next/api/functions/createTextWatermark).
- [ImageWatermark Options](https://tradingview.github.io/lightweight-charts/docs/next/api/interfaces/ImageWatermarkOptions)
