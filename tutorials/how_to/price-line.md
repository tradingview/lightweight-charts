...
[`createPriceLine`](https://tradingview.github.io/lightweight-charts/docs/api/interfaces/ISeriesApi#createpriceline) method on an existing series
([ISeriesApi](https://tradingview.github.io/lightweight-charts/docs/api/interfaces/ISeriesApi)) instance.
...
- [createPriceLine](https://tradingview.github.io/lightweight-charts/docs/api/interfaces/ISeriesApi#createpriceline) - Method to create a new Price Line.
- [PriceLineOptions](https://tradingview.github.io/lightweight-charts/docs/api/interfaces/PriceLineOptions) - Price Line options.
- [LineStyle](https://tradingview.github.io/lightweight-charts/docs/api/enumerations/LineStyle) - Available line styles.
