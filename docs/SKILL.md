...
Read [AGENT.md](./AGENT.md) first for repo-level rules.
Use [REFERENCE.md](./REFERENCE.md) as the routing/index layer to find the exact canonical docs, examples, and APIs referenced below.
...
If `REFERENCE.md` tells you **where** to look, `SKILL.md` tells you **how to think**.
...
3. Use `REFERENCE.md` to open the exact docs/examples/API entities.
...
- [`AGENT.md`](./AGENT.md) defines repo-level rules and workflow.
- [`SKILL.md`](./SKILL.md) defines mental models, task routing, and foot-guns.
- [`REFERENCE.md`](./REFERENCE.md) provides the searchable map to canonical material.
...
- `AGENT.md` stays short and stable.
- `SKILL.md` changes only when repeated mistakes or important usage patterns emerge.
- `REFERENCE.md` can stay generated and broad without becoming the place for policy or instruction.
