...
> Start with [AGENT.md](./AGENT.md) for repo rules and [SKILL.md](./SKILL.md) for task playbooks.
...
- [AGENT.md](./AGENT.md) — repo operating rules
- [SKILL.md](./SKILL.md) — task playbook, mental model, and foot-guns
