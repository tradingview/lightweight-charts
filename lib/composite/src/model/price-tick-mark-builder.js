...
exports.PriceTickMarkBuilder = void 0;
const mathex_1 = require("../helpers/mathex");
const price_tick_span_calculator_1 = require("./price-tick-span-calculator");
...
class PriceTickMarkBuilder {
    ...
    tickSpan(high, low) {
        ...
        const spanCalculator1 = new price_tick_span_calculator_1.PriceTickSpanCalculator(this._base, [2, 2.5, 2]);
        const spanCalculator2 = new price_tick_span_calculator_1.PriceTickSpanCalculator(this._base, [2, 2, 2.5]);
        const spanCalculator3 = new price_tick_span_calculator_1.PriceTickSpanCalculator(this._base, [2.5, 2, 2]);
        const spans = [];
...
exports.PriceTickMarkBuilder = PriceTickMarkBuilder;
