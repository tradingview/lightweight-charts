...
exports.SeriesBarColorer = void 0;
...
const barStyleFnMap = {
    ...
    Bar: (findBar, barStyle, barIndex, precomputedBars) => {
        ...
        const currentBar = (0, assertions_1.ensureNotNull)(findBar(barIndex, precomputedBars));
        const isUp = (0, assertions_1.ensure)(currentBar.value[0 /* PlotRowValueIndex.Open */]) <= (0, assertions_1.ensure)(currentBar.value[3 /* PlotRowValueIndex.Close */]);
        return {
...
exports.SeriesBarColorer = SeriesBarColorer;
