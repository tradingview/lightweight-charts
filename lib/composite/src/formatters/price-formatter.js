...
exports.PriceFormatter = exports.numberToStringWithLeadingZero = void 0;
...
function numberToStringWithLeadingZero(value, length) {
    if (!(0, strict_type_checks_1.isNumber)(value)) {
        return 'n/a';
    }
    if (!(0, strict_type_checks_1.isInteger)(length)) {
...
exports.numberToStringWithLeadingZero = numberToStringWithLeadingZero;
class PriceFormatter {
    constructor(priceScale, minMove) {
        if (!minMove) {
            minMove = 1;
        }
        if (!(0, strict_type_checks_1.isNumber)(priceScale) || !(0, strict_type_checks_1.isInteger)(priceScale)) {
            priceScale = 100;
        }
        if (priceScale < 0) {
