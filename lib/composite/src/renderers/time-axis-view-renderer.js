...
exports.TimeAxisViewRenderer = void 0;
...
class TimeAxisViewRenderer {
    ...
    draw(target, rendererOptions) {
        ...
        const textWidth = target.useMediaCoordinateSpace(({ context: ctx }) => {
            ...
            return Math.round(rendererOptions.widthCache.measureText(ctx, (0, assertions_1.ensureNotNull)(this._data).text, optimizationReplacementRe));
        });
        if (textWidth <= 0) {
            return;
        }
...
exports.TimeAxisViewRenderer = TimeAxisViewRenderer;
