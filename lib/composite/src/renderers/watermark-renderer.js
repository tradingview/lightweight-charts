...
exports.WatermarkRenderer = void 0;
const media_coordinates_pane_renderer_1 = require("./media-coordinates-pane-renderer");
class WatermarkRenderer extends media_coordinates_pane_renderer_1.MediaCoordinatesPaneRenderer {
    constructor(data) {
        super();
