...
exports.PanePriceAxisView = void 0;
...
class PanePriceAxisView {
    constructor(priceAxisView, dataSource, chartModel) {
        ...
        this._textWidthCache = new text_width_cache_1.TextWidthCache(50); // when should we clear cache?
...
exports.PanePriceAxisView = PanePriceAxisView;
