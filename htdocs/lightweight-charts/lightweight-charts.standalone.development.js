/*!
 * @license
 * TradingView Lightweight Charts™ v4.2.0-dev+202312010256
...
(function () {
    ...
    class SeriesDrawingRenderer extends MediaCoordinatesPaneRenderer {
        constructor() {
            super(...arguments);
            this._private__data = null;
    ...
    function fillSizeAndY(rendererItem, marker, seriesData, offsets, textHeight, shapeMargin, priceScale, timeScale, firstValue) {
        ...
        const sizeMultiplier = isNumber(marker._internal_size) ? Math.max(marker._internal_size, 0) : 1;
        ...
        switch (marker._internal_position) {
            case 'inBar': {
        ...
        ensureNever(marker._internal_position);
    }
        ...
        _internal__makeValid() {
            ...
            if (this._private__dataInvalidated) {
                this._private__data._internal_items = seriesMarkers.map((marker) => ({
                    _internal_time: marker._internal_time,
                    _internal_x: 0,
                    _internal_y: 0,
                    _internal_size: 0,
                    _internal_shape: marker._internal_shape,
                    _internal_color: marker._internal_color,
                    _internal_internalId: marker._internal_internalId,
                    _internal_externalId: marker._internal_id,
    ...
    class Series extends PriceDataSource {
        ...
        _internal_setData(data, updateInfo) {
            ...
            this._private__drawingPaneView._internal_update('data');
        ...
        _internal_paneViews() {
            ...
            res.push(this._private__paneView, this._private__priceLineView, this._private__drawingPaneView);
        ...
        _internal_updateAllViews() {
            var _a;
            this._private__paneView._internal_update();
            this._private__drawingPaneView._internal_update();
        ...
        _private__autoscaleInfoImpl(startTimePoint, endTimePoint) {
            ...
            let margins = this._private__drawingPaneView._internal_autoScaleMargins();
        ...
        _private__recreatePaneViews(customPaneView) {
            this._private__drawingPaneView = new SeriesDrawingPaneView(this, this._internal_model());
            switch (this._private__seriesType) {
                case 'Bar': {
    ...
    (function (TickMarkType) {
        ...
        TickMarkType[TickMarkType["Week"] = 2] = "Week";
        /**
         * A day of the month.
         */
        TickMarkType[TickMarkType["DayOfMonth"] = 3] = "DayOfMonth";
        /**
         * A time without seconds.
         */
        TickMarkType[TickMarkType["Time"] = 4] = "Time";
    ...
    function defaultTickMarkFormatter(timePoint, tickMarkType, locale) {
        ...
        switch (tickMarkType) {
            ...
            case 1 /* TickMarkType.Month */:
                ...
                break;
            case 3 /* TickMarkType.DayOfMonth */:
                formatOptions.day = 'numeric';
                break;
            case 4 /* TickMarkType.Time */:
    ...
    const intradayWeightDivisors = [
        { _internal_divisor: minutes(5), _internal_weight: 5 /* TickMarkWeight.Minute5 */ },
        { _internal_divisor: minutes(15), _internal_weight: 15 /* TickMarkWeight.Minute15 */ },
        { _internal_divisor: minutes(30), _internal_weight: 30 /* TickMarkWeight.Minute30 */ },
        { _internal_divisor: hours(1), _internal_weight: 60 /* TickMarkWeight.Hour1 */ },
    ];
    function weightByTime(currentDate, prevDate) {
        if (currentDate.getUTCFullYear() !== prevDate.getUTCFullYear()) {
            return 103 /* TickMarkWeight.Year */;
        }
        else if (currentDate.getUTCMonth() !== prevDate.getUTCMonth()) {
            return 102 /* TickMarkWeight.Month */;
        }
        else if (currentDate.getUTCDate() !== prevDate.getUTCDate()) {
            return 100 /* TickMarkWeight.Day */;
        }
        ...
        return 5 /* TickMarkWeight.Minute5 */;
    }
    function cast(t) {
        return t;
    }
    ...
    function weightToTickMarkType(weight, timeVisible, secondsVisible) {
        switch (weight) {
            case 5 /* TickMarkWeight.Minute5 */:
            case 15 /* TickMarkWeight.Minute15 */:
            case 30 /* TickMarkWeight.Minute30 */:
            case 60 /* TickMarkWeight.Hour1 */:
                return timeVisible ? 4 /* TickMarkType.Time */ : 3 /* TickMarkType.DayOfMonth */;
            case 100 /* TickMarkWeight.Day */:
                return 3 /* TickMarkType.DayOfMonth */;
            case 101 /* TickMarkWeight.Week */:
                return 3 /* TickMarkType.DayOfMonth */;
            case 102 /* TickMarkWeight.Month */:
                return 1 /* TickMarkType.Month */;
            case 103 /* TickMarkWeight.Year */:
    ...
    class HorzScaleBehaviorTime {
        ...
        maxTickMarkWeight(tickMarks) {
            ...
            if (maxWeight > 60 /* TickMarkWeight.Hour1 */ && maxWeight < 100 /* TickMarkWeight.Day */) {
                maxWeight = 60 /* TickMarkWeight.Hour1 */;
            }
            return maxWeight;
        }
    ...
    class MouseHandlerDataModel {
        constructor(mouseEnterHandler, mouseLeaveHandler, mouseHoverHandler, mouseDownEventHandler, mouseUpEventHandler, onMouseClickHandler, tapEventHandler, doubleTapEventHandler, longTapEventHandler) {
            this._internal_mouseEnterHandler = mouseEnterHandler;
            this._internal_mouseLeaveHandler = mouseLeaveHandler;
            this._internal_mouseHoverHandler = mouseHoverHandler;
            this._internal_mouseDownEventHandler = mouseDownEventHandler;
            this._internal_mouseUpEventHandler = mouseUpEventHandler;
            this._internal_onMouseClickHandler = onMouseClickHandler;
            this._internal_tapEventHandler = tapEventHandler;
            this._internal_doubleTapEventHandler = doubleTapEventHandler;
            this._internal_longTapEventHandler = longTapEventHandler;
        }
        _internal_getMouseEnterHandler() {
            return this._internal_mouseEnterHandler;
        }
        _internal_getMouseLeaveHandler() {
            return this._internal_mouseLeaveHandler;
        }
        _internal_getMouseHoverHandler() {
            return this._internal_mouseHoverHandler;
        }
        _internal_getMouseDownEventHandler() {
            return this._internal_mouseDownEventHandler;
        }
        _internal_getMouseUpEventHandler() {
            return this._internal_mouseUpEventHandler;
        }
        _internal_getMouseClickHandler() {
            return this._internal_onMouseClickHandler;
        }
        _internal_getTapEventHandler() {
            return this._internal_tapEventHandler;
        }
        _internal_getDoubleTapEventHandler() {
            return this._internal_doubleTapEventHandler;
        }
        _internal_getLongTapEventHandler() {
            return this._internal_longTapEventHandler;
        }
        _internal_setMouseEnterHandler(mouseEnterHandler) {
            this._internal_mouseEnterHandler = mouseEnterHandler;
        }
        _internal_setMouseLeaveHandler(mouseLeaveHandler) {
            this._internal_mouseLeaveHandler = mouseLeaveHandler;
        }
        _internal_setMouseHoverHandler(mouseHoverHandler) {
            this._internal_mouseHoverHandler = mouseHoverHandler;
        }
        _internal_setMouseDownEventHandler(mouseDownEventHandler) {
            this._internal_mouseDownEventHandler = mouseDownEventHandler;
        }
        _internal_setMouseUpEventHandler(mouseUpEventHandler) {
            this._internal_mouseUpEventHandler = mouseUpEventHandler;
        }
        _internal_setMouseClickHandler(onMouseClickHandler) {
            this._internal_onMouseClickHandler = onMouseClickHandler;
        }
        _internal_setTapEventHandler(tapEventHandler) {
            this._internal_tapEventHandler = tapEventHandler;
        }
        _internal_setDoubleTapEventHandler(doubleTapEventHandler) {
            this._internal_doubleTapEventHandler = doubleTapEventHandler;
        }
        _internal_setLongTapEventHandler(longTapEventHandler) {
            this._internal_longTapEventHandler = longTapEventHandler;
        }
    }

    class TrendLineDrawingController {
        constructor(chart, domElement, klines, xspan, candleseries) {
            this._internal_chart = null;
            this._internal_klines = null;
            this._internal_xspan = null;
            this._internal_candleseries = null;
            this._internal_lineSeries = null;
            // handle chart status
            this._private_isUpdatingLine = false;
            this._private_isDragging = false;
            this._private_isHovered = false;
            this._private_startPoint = null;
            this._private_selectedPoint = null; //null/0/1
            this._private_dragStartPoint = null;
            this._private_dragStartLineData = [{ time: '', value: '' }];
            this._private_lastCrosshairPosition = null;
            this._private_hoverThreshold = 0.1;
            this._internal_mouseEnterHandler = (param) => {
                console.log('mouse enter: ', param);
            };
            this._internal_mouseLeaveHandler = (param) => {
                console.log('mouse leave: ', param);
            };
            this._internal_mouseHoverHandler = (param) => {
                // console.log('mouse hover: ', param);
                if (this._private_isUpdatingLine || !param.point)
                    return;
                const xTs = param.time
                    ? param.time
                    : (this._internal_klines[0].time + param.logical * this._internal_xspan);
                const yPrice = this._internal_candleseries.coordinateToPrice(param.point.y);
                this._private_lastCrosshairPosition = { x: xTs, y: yPrice };
                this._private_startPoint
                    ? this._internal_updateLine(xTs, yPrice)
                    : this._internal_handleHoverEffect(xTs, yPrice);
                if (this._private_isDragging) {
                    const deltaX = xTs - this._private_dragStartPoint.x;
                    const deltaY = yPrice - this._private_dragStartPoint.y;
                    let newLineData;
                    newLineData = this._private_dragStartLineData.map((point, i) => this._private_selectedPoint !== null
                        ? i === this._private_selectedPoint
                            ? {
                    ...
                    if (newLineData[0].time === newLineData[1].time)
                        return;
                    // newLineData.sort((a, b) => a.time - b.time);
                    this._internal_dragLine(newLineData);
                }
            };
            this._internal_mouseDownEventHandler = (param) => {
                console.log('mouse down: ', param);
                if (!this._private_lastCrosshairPosition)
                    return;
                if (this._private_isHovered) {
                    this._internal_startDrag(this._private_lastCrosshairPosition.x, this._private_lastCrosshairPosition.y);
                }
            };
            this._internal_mouseUpEventHandler = (param) => {
                console.log('mouse up: ', param);
                this._internal_endDrag();
            };
            this._internal_onMouseClickHandler = (param) => {
                console.log('mouse click: ', param);
                console.log("handleChartClick triggered");
                if (this._private_isUpdatingLine)
                    return;
                if (this._private_isDragging)
                    return;
                const xTs = param.time
                    ...
                    : this._internal_klines[0].time + param.logical * this._internal_xspan;
                const yPrice = this._internal_candleseries.coordinateToPrice(param.point.y);
                this._private_isHovered
                    ? this._internal_startDrag(xTs, yPrice)
                    : this._internal_handleLineDrawing(xTs, yPrice);
            };
            this._internal_tapEventHandler = (param) => {
                console.log('tag: ', param);
            };
            this._internal_doubleTapEventHandler = (param) => {
                console.log('double tag: ', param);
            };
            this._internal_longTapEventHandler = (param) => {
                console.log('long tag: ', param);
            };
            this._internal_chart = chart;
            this._internal_domElement = domElement;
            this._internal_klines = klines;
            this._internal_xspan = xspan;
            this._internal_candleseries = candleseries;
            this._internal_lineSeries = this._internal_chart.addLineSeries();
        }
        _internal_mouseHandler() {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j;
            this._private_mouseHandlerDataModel = new MouseHandlerDataModel(this._internal_mouseEnterHandler, this._internal_mouseLeaveHandler, this._internal_mouseHoverHandler, this._internal_mouseDownEventHandler, this._internal_mouseUpEventHandler, this._internal_onMouseClickHandler, this._internal_tapEventHandler, this._internal_doubleTapEventHandler, this._internal_longTapEventHandler);
            (_a = this._internal_chart) === null || _a === void 0 ? void 0 : _a.subscribeMouseEnterEvent(this._private_mouseHandlerDataModel._internal_mouseEnterHandler);
            (_b = this._internal_chart) === null || _b === void 0 ? void 0 : _b.subscribeMouseLeaveEvent(this._private_mouseHandlerDataModel._internal_mouseLeaveHandler);
            (_c = this._internal_chart) === null || _c === void 0 ? void 0 : _c.subscribeCrosshairMove(this._private_mouseHandlerDataModel._internal_mouseHoverHandler);
            (_d = this._internal_chart) === null || _d === void 0 ? void 0 : _d.subscribeMouseDownEvent(this._private_mouseHandlerDataModel._internal_mouseDownEventHandler);
            (_e = this._internal_chart) === null || _e === void 0 ? void 0 : _e.subscribeMouseUpEvent(this._private_mouseHandlerDataModel._internal_mouseUpEventHandler);
            (_f = this._internal_chart) === null || _f === void 0 ? void 0 : _f.subscribeClick(this._private_mouseHandlerDataModel._internal_onMouseClickHandler);
            (_g = this._internal_chart) === null || _g === void 0 ? void 0 : _g.subscribeTapEvent(this._private_mouseHandlerDataModel._internal_tapEventHandler);
            (_h = this._internal_chart) === null || _h === void 0 ? void 0 : _h.subscribeDoubleTapEvent(this._private_mouseHandlerDataModel._internal_doubleTapEventHandler);
            (_j = this._internal_chart) === null || _j === void 0 ? void 0 : _j.subscribeLongTapEvent(this._private_mouseHandlerDataModel._internal_longTapEventHandler);
        }
        _internal_handleLineDrawing(xTs, yPrice) {
            if (!this._private_startPoint) {
                this._private_startPoint = { time: xTs, price: yPrice };
            }
            else {
                if (this._private_startPoint.time === xTs)
                    return;
                let newData = [
                    { _internal_time: this._private_startPoint.time, _internal_value: this._private_startPoint.price },
                    { _internal_time: xTs, _internal_value: yPrice },
                ];
                newData.sort((a, b) => a._internal_time - b._internal_time);
                this._internal_lineSeries.setData(newData);
                this._private_startPoint = null;
                this._private_selectedPoint = null;
            }
        }
        _internal_handleHoverEffect(xTs, yPrice) {
            const linedata = this._internal_lineSeries.data();
            if (!linedata.length)
                return;
            const hoverStatus = this._internal_isLineHovered(xTs, yPrice, linedata[0], linedata[1]);
            if (hoverStatus && !this._private_isHovered) {
                this._internal_startHover();
            }
            if (!hoverStatus && this._private_isHovered && !this._private_isDragging) {
                this._internal_endHover();
            }
        }
        _internal_startHover() {
            this._private_isHovered = true;
            this._internal_lineSeries.applyOptions({ color: "orange" });
            this._internal_domElement.style.cursor = "pointer";
            this._internal_chart.applyOptions({ handleScroll: false, handleScale: false });
        }
        _internal_endHover() {
            this._private_isHovered = false;
            this._internal_lineSeries.applyOptions({ color: "dodgerblue" });
            this._internal_domElement.style.cursor = "default";
            this._internal_chart.applyOptions({ handleScroll: true, handleScale: true });
        }
        _internal_startDrag(xTs, yPrice) {
            console.log("startDrag triggered");
            this._private_isDragging = true;
            this._private_dragStartPoint = { x: xTs, y: yPrice };
            this._private_dragStartLineData = [...this._internal_lineSeries.data()];
        }
        _internal_endDrag() {
            console.log("endDrag triggered");
            this._private_isDragging = false;
            this._private_dragStartPoint = null;
            this._private_dragStartLineData = [];
            this._private_selectedPoint = null;
        }
        _internal_updateLine(xTs, yPrice) {
            // try {
            if (this._private_startPoint.time === xTs)
                return;
            this._private_isUpdatingLine = true;
            let newData = [
                { _internal_time: this._private_startPoint.time, _internal_value: this._private_startPoint.price },
                { _internal_time: xTs, _internal_value: yPrice },
            ];
        ...
        _internal_dragLine(newCords) {
            this._private_isUpdatingLine = true;
            this._internal_lineSeries.setData(newCords);
            this._private_isUpdatingLine = false;
        }
        _internal_isLineHovered(xTs, yPrice, point1, point2) {
            // CHECK IF POINT IS SELECTED
            if (this._private_isDragging)
                return true;
            const isPoint1 = xTs === point1.time &&
                (Math.abs(yPrice - point1.value) * 100) / yPrice < this._private_hoverThreshold;
            if (isPoint1) {
                this._private_selectedPoint = 0;
                return true;
            }
            const isPoint2 = xTs === point2.time &&
                (Math.abs(yPrice - point2.value) * 100) / yPrice < this._private_hoverThreshold;
            if (isPoint2) {
                this._private_selectedPoint = 1;
                return true;
            }
            this._private_selectedPoint = null;
            ...
            return (Math.abs(yPrice - estimatedY) * 100) / yPrice < this._private_hoverThreshold;
        }
        _internal_unsubscribeMouseEvent() {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j;
            if (!this._private_mouseHandlerDataModel)
                return;
            (_a = this._internal_chart) === null || _a === void 0 ? void 0 : _a.unsubscribeCrosshairMove(this._private_mouseHandlerDataModel._internal_mouseHoverHandler);
            (_b = this._internal_chart) === null || _b === void 0 ? void 0 : _b.unsubscribeMouseDownEvent(this._private_mouseHandlerDataModel._internal_mouseDownEventHandler);
            (_c = this._internal_chart) === null || _c === void 0 ? void 0 : _c.unsubscribeMouseUpEvent(this._private_mouseHandlerDataModel._internal_mouseUpEventHandler);
            (_d = this._internal_chart) === null || _d === void 0 ? void 0 : _d.unsubscribeClick(this._private_mouseHandlerDataModel._internal_onMouseClickHandler);
            (_e = this._internal_chart) === null || _e === void 0 ? void 0 : _e.unsubscribeTapEvent(this._private_mouseHandlerDataModel._internal_tapEventHandler);
            (_f = this._internal_chart) === null || _f === void 0 ? void 0 : _f.unsubscribeDoubleTapEvent(this._private_mouseHandlerDataModel._internal_doubleTapEventHandler);
            (_g = this._internal_chart) === null || _g === void 0 ? void 0 : _g.unsubscribeLongTapEvent(this._private_mouseHandlerDataModel._internal_longTapEventHandler);
            (_h = this._internal_chart) === null || _h === void 0 ? void 0 : _h.unsubscribeMouseEnterEvent(this._private_mouseHandlerDataModel._internal_mouseEnterHandler);
            (_j = this._internal_chart) === null || _j === void 0 ? void 0 : _j.unsubscribeMouseLeaveEvent(this._private_mouseHandlerDataModel._internal_mouseLeaveHandler);
        }
        _internal_destory() {
            this._internal_unsubscribeMouseEvent();
            this._private_mouseHandlerDataModel = undefined;
            this._private_dragStartLineData = [];
        }
    }
    ...
    class PaneWidget {
        constructor(chart, state) {
            ...
            this._private__mouseEnter = new Delegate();
            this._private__mouseLeave = new Delegate();
            this._private__mobileTap = new Delegate();
            this._private__doubleMobileTap = new Delegate();
            this._private__longMobileTap = new Delegate();
        ...
        _internal_mouseEnterEvent(event) {
            ...
            this._private__fireMouseEnterDelegate(event);
        }
        _internal_mouseDownEvent(event) {
            ...
            this._private__fireMouseClickDownDelegate(event);
        }
        ...
        _internal_doubleTapEvent(event) {
            var _a;
            if (this._private__state !== null) {
                const hitTest = this._internal_hitTest(event.localX, event.localY);
                this._private__chart._internal_setCursorStyle((_a = hitTest === null || hitTest === void 0 ? void 0 : hitTest._internal_cursorStyle) !== null && _a !== void 0 ? _a : null);
                this._private__model()._internal_setHoveredSource(hitTest && { _internal_source: hitTest._internal_source, _internal_object: hitTest._internal_object });
            }
            this._internal_mouseDoubleClickEvent(event);
            this._private__fireMobileScreenDoubleTapDelegate(event);
            if (this._private__state !== null) {
        ...
        _internal_mouseUpEvent(event) {
            ...
            this._private__fireMouseClickUpDelegate(event);
        }
        _internal_tapEvent(event) {
            ...
            this._private__model()._internal_setHoveredSource(hitTest && { _internal_source: hitTest._internal_source, _internal_object: hitTest._internal_object });
            this._private__fireClickedDelegate(event);
            this._private__fireMobileScreenTapDelegate(event);
            this._private__state._internal_model()._internal_setHoveredSource(null);
        }
        _internal_longTapEvent(event) {
            ...
            if (this._private__startTrackPoint === null) {
                ...
                this._private__fireMobileScreenLongTapDelegate(event);
                if (this._private__state !== null) {
                    this._private__state._internal_model()._internal_setHoveredSource(null);
                }
            }
        ...
        _internal_mouseLeaveEvent(event) {
            ...
            this._private__fireMouseLeaveDelegate(event);
        }
        _internal_mouseEnter() {
            return this._private__mouseEnter;
        }
        _internal_mouseLeave() {
            return this._private__mouseLeave;
        }
        _internal_tap() {
            return this._private__mobileTap;
        }
        _internal_doubleTap() {
            return this._private__doubleMobileTap;
        }
        _internal_longTap() {
            return this._private__longMobileTap;
        }
        _internal_mouseDown() {
        ...
        _private__fireMouseEnterDelegate(event) {
            this._private__fireTapDelegate(this._private__mouseEnter, event);
        }
        _private__fireMouseLeaveDelegate(event) {
            this._private__fireTapDelegate(this._private__mouseLeave, event);
        }
        _private__fireMobileScreenTapDelegate(event) {
            this._private__fireTapDelegate(this._private__mobileTap, event);
        }
        _private__fireMobileScreenDoubleTapDelegate(event) {
            this._private__fireTapDelegate(this._private__doubleMobileTap, event);
        }
        _private__fireMobileScreenLongTapDelegate(event) {
            this._private__fireTapDelegate(this._private__longMobileTap, event);
        }
        _private__fireTapDelegate(delegate, event) {
            const x = event.localX;
            const y = event.localY;
        ...
        _private__fireMouseClickDownDelegate(event) {
            this._private__fireMouseClickDelegate(this._private__mouseDown, event);
        }
        _private__fireMouseClickUpDelegate(event) {
    ...
    class ChartWidget {
        constructor(container, options, horzScaleBehavior) {
            ...
            this._private__mouseEnter = new Delegate();
            this._private__mouseLeave = new Delegate();
            this._private__tap = new Delegate();
            this._private__doubleTap = new Delegate();
            this._private__longTap = new Delegate();
            this._private__mouseDown = new Delegate();
            this._private__mouseUp = new Delegate();
            this._private__clicked = new Delegate();
            this._private__dblClicked = new Delegate();
        ...
        _internal_destroy() {
            ...
            for (const paneWidget of this._private__paneWidgets) {
                ...
                paneWidget._internal_mouseEnter()._internal_unsubscribeAll(this);
                paneWidget._internal_mouseLeave()._internal_unsubscribeAll(this);
                paneWidget._internal_tap()._internal_unsubscribeAll(this);
                paneWidget._internal_doubleTap()._internal_unsubscribeAll(this);
                paneWidget._internal_longTap()._internal_unsubscribeAll(this);
            ...
            this._private__mouseEnter._internal_destroy();
            this._private__mouseLeave._internal_destroy();
            this._private__crosshairMoved._internal_destroy();
            this._private__tap._internal_destroy();
            this._private__doubleTap._internal_destroy();
            this._private__longTap._internal_destroy();
        ...
        _internal_tap() {
            return this._private__tap;
        }
        _internal_doubleTap() {
            return this._private__doubleTap;
        }
        _internal_longTap() {
            return this._private__longTap;
        }
        _internal_mouseDown() {
            return this._private__mouseDown;
        }
        ...
        _private__syncGuiWithModel() {
            ...
            for (let i = actualPaneWidgetsCount; i < targetPaneWidgetsCount; i++) {
                ...
                paneWidget._internal_mouseEnter()._internal_subscribe(this._private__onPaneWidgetMouseEnter.bind(this), this);
                paneWidget._internal_mouseLeave()._internal_subscribe(this._private__onPaneWidgetMouseLeave.bind(this), this);
                paneWidget._internal_tap()._internal_subscribe(this._private__onPaneWidgetTap.bind(this), this);
                paneWidget._internal_doubleTap()._internal_subscribe(this._private__onPaneWidgetDoubleTap.bind(this), this);
                paneWidget._internal_longTap()._internal_subscribe(this._private__onPaneWidgetLongTap.bind(this), this);
        ...
        _private__onPaneWidgetMouseEnter(time, point, event) {
            this._private__mouseEnter._internal_fire(() => this._private__getMouseEventParamsImpl(time, point, event));
        }
        _private__onPaneWidgetMouseLeave(time, point, event) {
            this._private__mouseLeave._internal_fire(() => this._private__getMouseEventParamsImpl(time, point, event));
        }
        _private__onPaneWidgetTap(time, point, event) {
            this._private__tap._internal_fire(() => this._private__getMouseEventParamsImpl(time, point, event));
        }
        _private__onPaneWidgetDoubleTap(time, point, event) {
            this._private__doubleTap._internal_fire(() => this._private__getMouseEventParamsImpl(time, point, event));
        }
        _private__onPaneWidgetLongTap(time, point, event) {
            this._private__longTap._internal_fire(() => this._private__getMouseEventParamsImpl(time, point, event));
        }
        _private__onPaneWidgetMouseDown(time, point, event) {
            this._private__mouseDown._internal_fire(() => this._private__getMouseEventParamsImpl(time, point, event));
        }
        _private__onPaneWidgetMouseUp(time, point, event) {
            this._private__mouseUp._internal_fire(() => this._private__getMouseEventParamsImpl(time, point, event));
        }
    ...
    ***************************************************************************** */
    ...
    class ChartApi {
        constructor(container, horzScaleBehavior, options) {
            ...
            this._private__mouseEnterEventDelegate = new Delegate();
            this._private__mouseLeaveEventDelegate = new Delegate();
            this._private__tapEventDelegate = new Delegate();
            this._private__doubleTapEventDelegate = new Delegate();
            this._private__longTapEventDelegate = new Delegate();
            this._private__mouseDownEventDelegate = new Delegate();
            this._private__mouseUpEventDelegate = new Delegate();
            ...
            this._private__chartWidget._internal_mouseEnter()._internal_subscribe((paramSupplier) => {
                if (this._private__mouseEnterEventDelegate._internal_hasListeners()) {
                    this._private__mouseEnterEventDelegate._internal_fire(this._private__convertMouseParams(paramSupplier()));
                }
            });
            this._private__chartWidget._internal_mouseLeave()._internal_subscribe((paramSupplier) => {
                if (this._private__mouseLeaveEventDelegate._internal_hasListeners()) {
                    this._private__mouseLeaveEventDelegate._internal_fire(this._private__convertMouseParams(paramSupplier()));
                }
            });
            this._private__chartWidget._internal_tap()._internal_subscribe((paramSupplier) => {
                if (this._private__tapEventDelegate._internal_hasListeners()) {
                    this._private__tapEventDelegate._internal_fire(this._private__convertMouseParams(paramSupplier()));
                }
            });
            this._private__chartWidget._internal_doubleTap()._internal_subscribe((paramSupplier) => {
                if (this._private__doubleTapEventDelegate._internal_hasListeners()) {
                    this._private__doubleTapEventDelegate._internal_fire(this._private__convertMouseParams(paramSupplier()));
                }
            });
            this._private__chartWidget._internal_longTap()._internal_subscribe((paramSupplier) => {
                if (this._private__longTapEventDelegate._internal_hasListeners()) {
                    this._private__longTapEventDelegate._internal_fire(this._private__convertMouseParams(paramSupplier()));
                }
            });
            this._private__chartWidget._internal_mouseDown()._internal_subscribe((paramSupplier) => {
                if (this._private__mouseDownEventDelegate._internal_hasListeners()) {
                    this._private__mouseDownEventDelegate._internal_fire(this._private__convertMouseParams(paramSupplier()));
                }
            });
            this._private__chartWidget._internal_mouseUp()._internal_subscribe((paramSupplier) => {
                if (this._private__mouseUpEventDelegate._internal_hasListeners()) {
                    this._private__mouseUpEventDelegate._internal_fire(this._private__convertMouseParams(paramSupplier()));
                }
            });
        ...
        remove() {
            this._private__chartWidget._internal_mouseEnter()._internal_unsubscribeAll(this);
            this._private__chartWidget._internal_mouseLeave()._internal_unsubscribeAll(this);
            this._private__chartWidget._internal_tap()._internal_unsubscribeAll(this);
            this._private__chartWidget._internal_doubleTap()._internal_unsubscribeAll(this);
            this._private__chartWidget._internal_longTap()._internal_unsubscribeAll(this);
            ...
            this._private__mouseEnterEventDelegate._internal_destroy();
            this._private__mouseLeaveEventDelegate._internal_destroy();
            this._private__tapEventDelegate._internal_destroy();
            this._private__doubleTapEventDelegate._internal_destroy();
            this._private__longTapEventDelegate._internal_destroy();
            this._private__mouseDownEventDelegate._internal_destroy();
            this._private__mouseUpEventDelegate._internal_destroy();
        ...
        subscribeMouseEnterEvent(handler) {
            this._private__mouseEnterEventDelegate._internal_subscribe(handler);
        }
        unsubscribeMouseEnterEvent(handler) {
            this._private__mouseEnterEventDelegate._internal_unsubscribe(handler);
        }
        subscribeMouseLeaveEvent(handler) {
            this._private__mouseLeaveEventDelegate._internal_subscribe(handler);
        }
        unsubscribeMouseLeaveEvent(handler) {
            this._private__mouseLeaveEventDelegate._internal_unsubscribe(handler);
        }
        subscribeTapEvent(handler) {
            this._private__tapEventDelegate._internal_subscribe(handler);
        }
        unsubscribeTapEvent(handler) {
            this._private__tapEventDelegate._internal_unsubscribe(handler);
        }
        subscribeDoubleTapEvent(handler) {
            this._private__doubleTapEventDelegate._internal_subscribe(handler);
        }
        unsubscribeDoubleTapEvent(handler) {
            this._private__doubleTapEventDelegate._internal_unsubscribe(handler);
        }
        subscribeLongTapEvent(handler) {
            this._private__longTapEventDelegate._internal_subscribe(handler);
        }
        unsubscribeLongTapEvent(handler) {
            this._private__longTapEventDelegate._internal_unsubscribe(handler);
        }
        subscribeMouseDownEvent(handler) {
            this._private__mouseDownEventDelegate._internal_subscribe(handler);
        }
        unsubscribeMouseDownEvent(handler) {
            this._private__mouseDownEventDelegate._internal_unsubscribe(handler);
        }
        subscribeMouseUpEvent(handler) {
            this._private__mouseUpEventDelegate._internal_subscribe(handler);
        }
        unsubscribeMouseUpEvent(handler) {
            this._private__mouseUpEventDelegate._internal_unsubscribe(handler);
        }
        ...
        _private__convertMouseParams(param) {
            ...
            param._internal_seriesData.forEach((plotRow, series) => {
                ...
                price = series._internal_model()._internal_crosshairSource()._internal_price();
        ...
        initTrendLineDrawingController(chart, domElement, klines, xspan, candleseries) {
            const trendLineController = new TrendLineDrawingController(chart, domElement, klines, xspan, candleseries);
            trendLineController._internal_mouseHandler();
        }
    }
