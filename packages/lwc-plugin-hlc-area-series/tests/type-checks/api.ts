...
import { HLCAreaSeries, type HLCAreaData, type HLCAreaSeriesOptions } from '@tradingview/lwc-plugin-hlc-area-series';
...
const tagged = categoryChart.addCustomSeries(new HLCAreaSeries<Category, TaggedPoint>());
