...
See [Build with AI](https://tradingview.github.io/lightweight-charts/docs/ai.md) for the Agent Skill that teaches AI coding assistants how to work with Lightweight Charts™, and for how to point AI tools at this documentation directly.
...
As a parameter, specify a [series type](https://tradingview.github.io/lightweight-charts/docs/series-types.md) you would like to create:
