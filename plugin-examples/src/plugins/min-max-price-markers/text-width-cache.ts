/**
 * @link https://github.dev/tradingview/lightweight-charts
 */
...
export class TextWidthCache {
	...
	private _cache: Map<string, { metrics: TextMetrics; tick: number }> =
		new Map();
	...
	private _getMetrics(
		...
		if (this._cache.has(cacheString)) {
			return this._cache.get(cacheString)!.metrics;
		}
