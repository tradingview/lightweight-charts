...
import {
	OptionPriceSeriesOptions,
} from './option-price-series';
import { OptionPriceSeriesData } from './data';
...
export class OptionPriceSeriesRenderer<TData extends OptionPriceSeriesData>
	implements ICustomSeriesPaneRenderer
{
	_data: PaneRendererCustomData<Time, TData> | null = null;
	_options: OptionPriceSeriesOptions | null = null;
	...
	_drawImpl(
		...
		const bars: BarItem[] = this._data.bars.map(bar => {
			...
			const isUp = bar.originalData.isCall;
