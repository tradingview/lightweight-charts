...
import { InternalSeriesDrawing } from "../../model/series-drawing";
import {
	SeriesDrawingRenderer,
	SeriesDrawingRendererData,
	SeriesDrawingRendererDataItem,
} from "../../renderers/series-drawing-renderer";
...
function fillSizeAndY(
	rendererItem: SeriesDrawingRendererDataItem,
	marker: InternalSeriesDrawing<TimePointIndex>,
...
export class SeriesDrawingPaneView implements IUpdatablePaneView {
	...
	private _data: SeriesDrawingRendererData;
	...
	protected _makeValid(): void {
		...
		if (this._dataInvalidated) {
			this._data.items = seriesMarkers.map<SeriesDrawingRendererDataItem>((marker: InternalSeriesDrawing<TimePointIndex>) => ({
				time: marker.time,
				x: 0 as Coordinate,
				y: 0 as Coordinate,
				size: 0,
