...
properties to further enhance its accessibility in addition to generating
...
On the other hand, `aria-hidden` is used to hide irrelevant or redundant
...
The example describes the chart based on it's first, and last visible data
