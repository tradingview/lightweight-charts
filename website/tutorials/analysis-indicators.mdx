...
These examples are designed to be a starting point for creating your own indicators and can be used directly in your projects.

The examples are self-contained and are not published on NPM.
There are two different options for integrating into your project.
Also, there are two approaches to add the indicators on the chart.

### Available indicators

Below is a list of indicators where each link points to their source code on GitHub.

- [Average Price](https://github.com/tradingview/lightweight-charts/indicator-examples/src/indicators/average-price)
- [Correlation](https://github.com/tradingview/lightweight-charts/indicator-examples/src/indicators/correlation)
- [Median Price](https://github.com/tradingview/lightweight-charts/indicator-examples/src/indicators/median-price)
- [Momentum](https://github.com/tradingview/lightweight-charts/indicator-examples/src/indicators/momentum)
- [Simple Moving Average](https://github.com/tradingview/lightweight-charts/indicator-examples/src/indicators/moving-average)
- [Percent Change](https://github.com/tradingview/lightweight-charts/indicator-examples/src/indicators/percent-change)
- [Product](https://github.com/tradingview/lightweight-charts/indicator-examples/src/indicators/product)
- [Ratio](https://github.com/tradingview/lightweight-charts/indicator-examples/src/indicators/ratio)
- [Spread](https://github.com/tradingview/lightweight-charts/indicator-examples/src/indicators/spread)
- [Sum](https://github.com/tradingview/lightweight-charts/indicator-examples/src/indicators/sum)
- [Weighted Close](https://github.com/tradingview/lightweight-charts/indicator-examples/src/indicators/weighted-close)
...
Since these examples are not available on a package manager like NPM, you have two options for integrating them into your project.
...
When a change is detected, it re-fetches the data, runs the calculation, and updates the indicator series automatically.
...
You are responsible for manually re-calculating the indicator and calling `smaSeries.setData()` again.
