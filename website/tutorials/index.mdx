...
The [analysis indicator examples](./tutorials/analysis-indicators) below serve as a starting point for creating your own indicators. You can use them directly in your projects.
