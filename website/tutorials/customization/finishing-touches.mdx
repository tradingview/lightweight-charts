...
## Automatically resizing the chart when the window is resized

Adding the following code snippet to the end of the script tag will make the chart resize automatically to fit the browser window whenever the window is resized.

:::caution

This will only work correctly if you want the chart to completely fill the window.
