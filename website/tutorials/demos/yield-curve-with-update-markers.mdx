...
[UpDownMarkersPrimitive](/docs/next/api/classes/UpDownMarkersPrimitive) plugin
...
The UpDownMarkersPrimitive is attached to the first series using
`series1.attachPrimitive(priceChangeMarkers)`. We then use
