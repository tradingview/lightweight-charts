...
objects to the [`createSeriesMarkers`](/docs/api#createSeriesMarkers) method on
...
- [createSeriesMarkers](/docs/next/api/interfaces/ISeriesApi#setmarkers) - Method for adding markers to a series.
