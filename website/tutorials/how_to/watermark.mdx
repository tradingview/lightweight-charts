...
A simple text watermark can be configured and added by using the [`createTextWatermark`](/docs/next/api#createTextWatermark) function exported
...
- [`createTextWatermark` function](/docs/next/api#createTextWatermark).
...
- [`createImageWatermark` pane primitive](/docs/next/api#createImageWatermark).
