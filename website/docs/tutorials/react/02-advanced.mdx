...
import Code from '!!raw-loader!@site/src/pages/_react/advanced-react-example';

<CodeBlock className="language-jsx">{Code}</CodeBlock>

The code above will produce a Series of type `line` Chart.
...
import { App } from '@site/src/pages/_react/advanced-react-example'
