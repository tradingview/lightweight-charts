...
import code from '!!raw-loader!@site/src/pages/_react/simple-react-example';
...
import { App } from '@site/src/pages/_react/simple-react-example'
import styles from '../../../src/pages/chart.module.css';
