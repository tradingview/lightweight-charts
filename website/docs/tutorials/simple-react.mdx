...
The following only describes a relatively simple example that only renders an [area series](../series-types.md#area) that could be tweaked to render any other type of [series](../series-types.md).

For a more complete scenario where you could wrap Lightweight Charts into a component having sub components, please consult this [example](./advanced-react-example).
...
import code from '!!raw-loader!./../../src/pages/_react/simple-react-example.jsx';
...
import { ChartComponent } from "../../src/pages/_react/simple-react-example"
