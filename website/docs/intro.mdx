...
See [Build with AI](./ai.md) for the Agent Skill that teaches AI coding assistants how to work with Lightweight Charts™, and for how to point AI tools at this documentation directly.
