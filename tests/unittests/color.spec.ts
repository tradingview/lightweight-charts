...
describe('generateContrastColors', () => {
	it('should work', () => {
		...
		expect(colorParser.generateContrastColors('rgb(255, 255, 255)')).to.be.deep.equal({ foreground: 'black', background: 'rgb(255, 255, 255)' });
		expect(colorParser.generateContrastColors('rgba(255, 255, 255, 0)')).to.be.deep.equal({ foreground: 'black', background: 'rgba(255, 255, 255, 0)' });
		expect(colorParser.generateContrastColors('rgba(255, 255, 255, 1)')).to.be.deep.equal({ foreground: 'black', background: 'rgba(255, 255, 255, 1)' });

		expect(colorParser.generateContrastColors('rgb(0, 0, 0)')).to.be.deep.equal({ foreground: 'white', background: 'rgb(0, 0, 0)' });
		expect(colorParser.generateContrastColors('rgb(0, 0, 0)')).to.be.deep.equal({ foreground: 'white', background: 'rgb(0, 0, 0)' });
		expect(colorParser.generateContrastColors('rgba(0, 0, 0, 0)')).to.be.deep.equal({ foreground: 'white', background: 'rgba(0, 0, 0, 0)' });
		expect(colorParser.generateContrastColors('rgba(0, 0, 0, 1)')).to.be.deep.equal({ foreground: 'white', background: 'rgba(0, 0, 0, 1)' });
	});
	...
	it('correct contrast color', () => {
		...
		expect(colorParser.generateContrastColors('rgba(150, 150, 150, 0)')).to.be.deep.equal({ foreground: 'white', background: 'rgba(150, 150, 150, 0)' });
		expect(colorParser.generateContrastColors('rgba(170, 170, 170, 0)')).to.be.deep.equal({ foreground: 'black', background: 'rgba(170, 170, 170, 0)' });
