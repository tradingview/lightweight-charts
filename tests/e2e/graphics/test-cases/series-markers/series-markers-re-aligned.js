...
function runTestCase(container) {
	...
	line.update({ time: '2017-04-10', value: 85.01 });
	line.update({ time: '2017-04-16', value: 85.01 });
	line.update({ time: '2017-04-17', value: 80.01 });
	line.update({ time: '2017-04-18', value: 85.01 });
	line.update({ time: '2017-04-24', value: 85.01 });
