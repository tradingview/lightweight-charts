...
/**
 * Options for product calculation between two sets of series data.
 *
 ...
 * and times their values. If values are missing or dates are mismatched
 ...
 * @param {ProductCalculationOptions<TPrimaryData, TSecondaryData>} options - Options for calculation, such as which property to use and mismatch handling.
 ...
 *
 * @example
 * const result = calculateProductIndicatorValues(
